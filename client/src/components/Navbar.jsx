...
function Navbar() {
  ...
  return (
    <div className='flex  justify-between items-center px-8 sm:px-20 xl:px-32 cursor pointer shadow max-sm:py-2'>
      ...
      <button onClick={()=>navigate('/admin')} className='flex items-center gap-2 rounded-full text-sm cursor-pointer bg-primary text-white px-5 max-sm:px-3 max-sm:mt-2 sm:px-10 py-2.5'>
