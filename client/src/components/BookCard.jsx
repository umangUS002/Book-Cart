...
function BookCard({blog}) {
  ...
  return (
    <div onClick={()=>navigate(`/book/${_id}`)} className='w-full rounded-lg overflow-hidden shadow hover:scale-102 hover:shadow-primary/25 duration-300 cursor-pointer'>
      ...
      <div className='p-5'>
        <h5 className='mb-1 font-medium text-gray-900'>{title}</h5>
